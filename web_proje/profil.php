...
<body>
   ...
   <div class="sidebar" style="padding-top: -25 !important; display: flex; flex-direction: column;">

        <!-- Logo Entegrasyonu ve Marka -->
        <a href="index.php" class="brand">
            <img src="logo.jpeg" alt="Logo" onerror="this.style.display='none'">
           <div style="text-align: center; width: 100%; margin-top: 40x;">
    <a href="index.php" style="text-decoration: none; display: inline-block;">
        <img src="logo.png" alt="Logo" style="height: 95px; width: auto; display: block; margin: 0 auto -20px auto;">
      
        <h2 style="margin: 0 0 50px 0; font-weight: 800; font-size: 1.8rem; color: #ffffff; letter-spacing: -1px;">
