...
// --- İLANLARI GETİR ---
$sql = "SELECT * FROM ilanlar WHERE ilan_tipi = 0 AND durum = 'aktif'";$params = [];
...
<head>
    ...
    <style>
        ...
        .navbar { background: linear-gradient(135deg, #0d6efd 0%, #0a58ca 100%); padding: -10px 0; }
...
<nav class="navbar sticky-top">
   <div class="container d-flex justify-content-between align-items-center">
        <a href="index.php" style="text-decoration: none; display: flex; align-items: center;">
            <img src="logo.png" alt="Logo" style="height:101px; margin-right: -44px;">
            <h2 style="margin: 0; font-weight: 800; font-size: 1.8rem; color: #ffffff;">
        ...
        <div class="d-flex align-items-center">
            <a href="cart.php" class="btn btn-success me-3 fw-bold">🛒 Sepetim</a>
